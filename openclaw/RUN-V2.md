# Run Strategy V2 (Late-Window Sniper)

Copy-paste this entire block into OpenClaw. It handles everything: clone, setup, cleanup, and start.

```
Set up and run the BTC trader with Strategy V2 (late-window sniper).
...
1. Read these docs for context:
   ...
   - ~/projects/btc-trader/STRATEGY_V2.md
...
V2 trades much less often (5-10% of windows) but with bigger bets on cheap tokens only.
V2 logs go to logs/btc-cycles-v2.jsonl and a separate Discord webhook.
